...
#import "SHDigTextCell.h"
#import "Masonry.h"
@interface SHDigTextCell ()

@property (nonatomic, weak) UILabel *diaTextLabel;
@end

@implementation SHDigTextCell


+ (instancetype)cellWithTableView:(UITableView *)tableView {

    NSString *ID = NSStringFromClass([SHDigTextCell class]);

    SHDigTextCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[SHDigTextCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
